...
class ClassTextFieldSizeClass: UITextField {
    ...
    override func awakeFromNib() {
        ...
        if self.placeholder != nil {
            self.attributedPlaceholder = NSAttributedString(string:self.placeholder!, attributes: [NSAttributedString.Key.foregroundColor: UIColor(named: "purpleColor")!])
        }
        switch UIDevice().type {
        case .iPhoneSE, .iPhone5, .iPhone5S, .iPhone5C:
            self.font = self.font?.withSize(self.font!.pointSize)
...
class ClassButtonSizeClass: CustomUIButton {
    ...
    override func awakeFromNib() {
        ...
        case .iPhone6plus, .iPhone6Splus, .iPhone7plus, .iPhone8plus:
            self.titleLabel?.font!.withSize(self.titleLabel!.font.pointSize + 4)
        case .iPhoneX, .iPhoneXR, .iPhoneXS, .iPhoneXSMax:
            self.titleLabel?.font!.withSize(self.titleLabel!.font.pointSize + 5)
        default:
            self.titleLabel?.font!.withSize(self.titleLabel!.font.pointSize + 10)
        }
    }
}
